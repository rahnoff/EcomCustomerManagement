namespace EcomCustomerManagement.Application.UpdatingCustomerInformation;
...
public class UpdateCustomerInformationHandler : ICommandHandler<UpdateCustomerInformation>
{
    ...
    public UpdateCustomerInformationHandler(IEventStoreRepository<Customer> customerWriteRepository)
    {
